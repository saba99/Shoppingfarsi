 ...
 @include('main.header')
            ...
            <div class="row blocks-spacer">
                ...
                <div class="span5">
                    <div class="product-preview">
                        <div class="picture">
                            <img src="{{asset('webmarket/images/dummy/products/shirt-1.jpg')}}" alt="" width="940" height="940" id="mainPreviewImg" />
                        </div>
                        <div class="thumbs clearfix">
                            <div class="thumb active">
                                <a href="#mainPreviewImg"><img src="{{asset('webmarket/images/dummy/products/shirt-1.jpg')}}" alt="" width="940" height="940" /></a>
                            </div>
                            <div class="thumb">
                                <a href="#mainPreviewImg"><img src="{{asset('webmarket/images/dummy/products/shirt-2.jpg')}}" alt="" width="940" height="940" /></a>
                            </div>
                            <div class="thumb">
                                <a href="#mainPreviewImg"><img src="{{asset('webmarket/images/dummy/products/shirt-3.jpg')}}" alt="" width="940" height="940" /></a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row popup-products">
            	...
            	<div class="span3">
            	    <div class="product">
            	        <div class="product-img">
                            <div class="picture">
                                <img src="{{asset('webmarket/images/dummy/products/product-1.jpg')}}" alt="" width="540" height="374" />
            	...
            	<div class="span3">
            	    <div class="product">
            	        <div class="product-img">
                            <div class="picture">
                                <img src="{{asset('webmarket/images/dummy/products/product-2.jpg')}}" alt="" width="540" height="374" />
                                <div class="img-overlay">
                                    <a href="#" class="btn more btn-primary">توضیحات بیشتر</a>
                                    <a href="#" class="btn buy btn-danger">اضافه به سبد خرید</a>
                                </div>
            	...
            	<div class="span3">
            	    <div class="product">
            	        <div class="product-img">
                            <div class="picture">
                                <img src="{{asset('webmarket/images/dummy/products/product-3.jpg')}}" alt="" width="540" height="374" />
                                <div class="img-overlay">
                                    <a href="#" class="btn more btn-primary">توضیحات بیشتر</a>
                                    <a href="#" class="btn buy btn-danger">اضافه به سبد خرید</a>
                                </div>
            	...
            	<div class="span3">
            	    <div class="product">
            	        <div class="product-img">
                            <div class="picture">
                                <img src="{{asset('webmarket/images/dummy/products/product-4.jpg')}}" alt="" width="540" height="374" />
                                <div class="img-overlay">
                                    <a href="#" class="btn more btn-primary">توضیحات بیشتر</a>
                                    <a href="#" class="btn buy btn-danger">اضافه به سبد خرید</a>
                                </div>
   ...
   @include('main.modalwindows')
    ...
    if (typeof jQuery == 'undefined') {
        document.write("<script src="{{asset('webmarket/js/jquery.min.js')}}"><\/script>");
    }
    </script>
    @section('scripts')
