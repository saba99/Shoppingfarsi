          ...
          <div itemscope itemtype="http://schema.org/محصولات">
            ...
            <div class="owl-carousel related_pro">
              ...
              <div class="product-thumb">
                <div class="image"><a href="product.html"><img src=""  class="img-responsive" /></a></div>
                <div class="caption">
                  <h4><a href=""></a></h4>
                  <p class="price"> <span class="price-new"></span> <span class="price-old">240000 تومان</span> <span class="saving">-5%</span> </p>
          ...
          <div class="side-item">
            ...
            <div class="product-thumb clearfix">
              <div class="image"><a href="product.html">
                <img src="" class="img-responsive" /></a></div>
              <div class="caption">
                <h4><a href="product.html">{{$product->title}}</a></h4>
                <p class="price"> <span class="price-new">{{$product->price}}</span> <span class="price-old">120000 تومان</span> <span class="saving">-26%</span> </p>
              </div>
            </div>
             @endforeach
