                 ...
                 @foreach($cart->items as $product)
                  <tr>
                    <td class="text-center">
                        {{--{{route('product',['slug',$product['item']->slug])}}--}}
                        <a href="">
                        <img src="{{$product['item']->files[0]->filename}}"  class="img-thumbnail" >
                    </a></td> 
                    ...
                    <td class="text-left"><div class="input-group btn-block quantity">
                        <input type="text" name="quantity" value="{{$product->qty}}" size="1" class="form-control" >
