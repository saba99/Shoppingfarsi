...
<div id="content" class="col-xs-12">
  ...
  <ul id="tabs" class="tabs">
    ...
    <li><a href="#tab-special">تصادفی</a></li>
  </ul>
  ...
  <div id="tab-latest" class="tab_content">
    <div class="owl-carousel product_carousel_tab">
      ...
      {{--@dd($RandomProducts)--}}
              ...
              {{--@dd($random->files[0]->filename)--}}
            <div class="product-thumb">                     {{--{{$random[0]->files[0]->filename}}--}}
              <div class="image">
                <a href="{{route('product.single', ['slug'=> $random->slug])}}">
                  <img src="{{$random->files[0]->filename}}"  class="img-responsive" /></a></div>
              <div class="caption">
                <h4><a href="{{route('product.single', ['slug'=> $random->slug])}}">{{$random->name}}</a></h4>
                <p class="price"> {{$random->price}} </p>
              </div>
              <div class="button-group">
                <button class="btn-primary" type="button" href="{{route('cart.add',['id'=>$product->id])}}"><span>افزودن به سبد</span></button>
                <div class="add-to-links">
