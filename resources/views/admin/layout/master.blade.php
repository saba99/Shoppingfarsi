...
<header class="main-header">
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span class="hidden-xs">ادمین فروشگاه صبا</span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
 ...
 @yield('main-content')
  ...
  <aside class="main-sidebar direction">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
          <a href="#">
            <i class="fa fa-edit"></i> <span>سفارشات</span>
            <i class="fa fa-angle-left pull-right"></i>
          </a>
          <ul class="treeview-menu">
            <li><a href="{{url('/administrator/orders')}}"><i class="fa fa-circle-o"></i> لیست سفارشات</a></li>
            
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
            <i class="fa fa-table"></i> <span>محصولات</span>
            <i class="fa fa-angle-left pull-right"></i>
          </a>
          <ul class="treeview-menu">
        ...
        <li class="treeview">
          <a href="#">
            <i class="fa fa-ticket"></i> <span> کد تخفیف</span>
            <i class="fa fa-angle-left pull-right"></i>
          </a>
          <ul class="treeview-menu">
             <li><a href="{{route('coupons.index')}}"><i class="fa fa-circle-o"></i>نمایش کد تخفیف</a></li>
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2015-2019 <a href="https://www.Sabashopping.ir">Shopping Admin </a>.</strong> All rights
    reserved.
  </footer>
        ...
        <ul class="control-sidebar-menu">
          <li>
            <a href="javascript:void(0)">
              ...
              <div class="menu-info">
                <h4 class="control-sidebar-subheading">LangdonBirthday</h4>
...
{{--<script src="https://cdnjs.cloudflare.com/ajax/libs/jqvmap/1.5.1/jquery.vmap.js"></script>
 <script src="https://cdnjs.cloudflare.com/ajax/libs/jvectormap/1.2.2/jquery-jvectormap.js"></script>--}}
