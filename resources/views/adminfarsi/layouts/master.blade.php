...
<head>
  ...
  <link src="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.11.2/css/all.min.css" rel="stylesheet">
  <!-- Ionicons -->
...
<div class="wrapper">
    ...
    <div class="sidebar" style="direction: ltr">
      <div style="direction: rtl">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
          ...
          <div class="info">
            <a href="#" class="d-block">صبا حصارکی</a>
          </div>
        </div>
        ...
        <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item has-treeview text-right">
  ...
  {{--<footer class="main-footer">
    <strong>CopyLeft &copy; 2018 <a href="http://github.com/saba99/">صبا حصارکی</a>.</strong>
