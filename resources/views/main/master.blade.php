...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
  <head>
    ...
    <!-- Twitter Bootstrap -->
    <link href="{{asset('webmarket/stylesheets/bootstrap.css')}}" rel="stylesheet">
    <link href="{{asset('webmarket/stylesheets/responsive.css')}}" rel="stylesheet">
    <!-- Slider Revolution -->
    <link rel="stylesheet" href="{{asset('webmarket/js/rs-plugin/css/settings.css')}}" type="text/css"/>
    <!-- jQuery UI -->
    <link rel="stylesheet" href="{{asset('webmarket/js/jquery-ui-1.10.3/css/smoothness/jquery-ui-1.10.3.custom.min.css')}}" type="text/css"/>
    <!-- PrettyPhoto -->
    <link rel="stylesheet" href="{{asset('webmarket/js/prettyphoto/css/prettyPhoto.css')}}" type="text/css"/>
    <!-- main styles -->
     
    <link href="{{asset('webmarket/stylesheets/main.css')}}" rel="stylesheet">
     
    

    <!-- Modernizr -->
    <script src="{{asset('webmarket/js/modernizr.custom.56918.js')}}"></script>    

    <!-- Fav and touch icons -->
    <link rel="apple-touch-icon-precomposed" sizes="144x144" href="images/apple-touch/144.png">
    <link rel="apple-touch-icon-precomposed" sizes="114x114" href="images/apple-touch/114.png">
    <link rel="apple-touch-icon-precomposed" sizes="72x72" href="images/apple-touch/72.png">
    <link rel="apple-touch-icon-precomposed" href="{{asset('webmarket/images/apple-touch/57.png')}}">
    <link rel="shortcut icon" href="{{asset('webmarket/images/apple-touch/57.png')}}">
  </head>
    ...
    <header id="header">
        <div class="container">
            <div class="row">
                ...
                <!--  ==========  -->
                <div class="span7">
                    <a class="brand" href="{{route('shopping.home')}}">
                ...
                <div class="nav-collapse collapse">
                  <ul class="nav" id="mainNavigation">
                    <li class="dropdown active">
                        ...
                        <ul class="dropdown-menu">
                            <li class="dropdown active">
                                ...
                                <ul class="dropdown-menu">
                                    <li class="active"><a href="{{route('shopping.home')}}">پوسته پیش فرض</a></li>
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a href="{{route('shopping.product.index')}}">قالب بندی پیش فرض</a></li>
                            <li><a href="shop-no-sidebar.html">تمام صفحه</a></li>
                            <li><a href="{{route('shopping.product.ShopProduct')}}">محصول تکی</a></li>
                            <li><a href="{{route('shopping.product.SearchProduct')}}">نتایج جستجو</a></li>
                        </ul>
                    </li>
                    <li class="dropdown">
                        <a href="blog.html" class="dropdown-toggle">بلاگ <b class="caret"></b> </a>
                        <ul class="dropdown-menu">
                            <li><a href="{{route('shopping.blog.index')}}">قالب بندی پیش فرض</a></li>
                            <li><a href="{{route('shopping.blog.BlogSingle')}}">تک نوشته</a></li>
                            <li><a href="{{route('shopping.blog.BlogSearch')}}">نتایج جستجو</a></li>
                            <li><a href="404.html">صفحه 404</a></li>
                        </ul>
                    </li>
                    <li class="dropdown">
                        <a href="{{route('shopping.features')}}" class="dropdown-toggle">امکانات <b class="caret"></b> </a>
                        <ul class="dropdown-menu">
                            <li><a href="icons.html">آیکن ها</a></li>
                            <li class="dropdown">
                                <a href="{{route('shopping.features')}}" class="dropdown-toggle"><i class="icon-caret-left pull-right visible-desktop"></i> همه امکانات</a>
                                <ul class="dropdown-menu">
                    ...
                    <li><a href="{{route('shopping.AboutUs')}}">درباره ما</a></li>
                    <li><a href="{{route('shopping.contact')}}">تماس با ما</a></li>
                  </ul>
                ...
                <div class="cart-container" id="cartContainer">
                    ...
                    <div class="open-panel">
                        ...
                        <div class="item-in-cart clearfix">
                            ...
                            <div class="desc">
                                <strong><a href="{{route('shopping.product.index')}}">کلاه زمستانی</a></strong>
                        ...
                        <div class="item-in-cart clearfix">
                            ...
                            <div class="desc">
                                <strong><a href="{{route('shopping.product.SearchProduct')}}">کمربند اسپورت</a></strong>
                                <span class="light-clr qty">
                                    تعداد : 1
                                    &nbsp;
                                    <a href="#" class="icon-remove-sign" title="Remove Item"></a>
                        ...
                        <div class="item-in-cart clearfix">
                            ...
                            <div class="desc">
                                <strong><a href="{{route('shopping.product.index')}}">کیف پول مردانه</a></strong>
                                <span class="light-clr qty">
                                    تعداد : 1
                                    &nbsp;
                                    <a href="#" class="icon-remove-sign" title="Remove Item"></a>
        ...
        <div class="fullwidthbanner">
            <ul>
                <li data-transition="premium-random" data-slotamount="3">
                    <img src="{{asset('webmarket/images/dummy/slides/1/slide.jpg')}}" alt="slider img" width="1400" height="377" />
                    ...
                    <div class="caption lft ltt"
                        ...
                        <img src="{{asset('webmarket/images/dummy/slides/1/baloon1.png')}}" alt="baloon" width="135" height="186" />
                    </div>
                    ...
                    <div class="caption lft ltt"
                        ...
                        data-start="1200" 
                        data-easing="easeOutElastic">
                        <img src="{{asset('webmarket/images/dummy/slides/1/baloon3.png')}}" alt="baloon" width="40" height="55" />
                    </div>
                    ...
                    <div class="caption lft ltt"
                        ...
                        data-start="1500" 
                        data-easing="easeOutElastic">
                        <img src="{{asset('webmarket/images/dummy/slides/1/baloon2.png')}}" alt="baloon" width="60" height="83" />
                    </div>
                ...
                <li data-transition="premium-random" data-slotamount="3">
                    <img src="{{asset('webmarket/images/dummy/slides/2/slide.jpg')}}" alt="slider img" width="1400" height="377" />
                    ...
                    <div class="caption lfb ltb"
                        ...
                        <img src="{{asset('webmarket/images/dummy/slides/2/woman.png')}}" alt="woman" width="361" height="374" />
                    </div>
                    ...
                    <div class="caption lfl str"
                        ...
                        data-start="1000" 
                        data-easing="linear">
                        <img src="{{asset('webmarket/images/dummy/slides/2/plane.png')}}" alt="aircraft" width="117" height="28" />
                    </div>
                ...
                <li data-transition="premium-random" data-slotamount="3">
                    <img src="{{asset('webmarket/images/dummy/slides/3/slide.jpg')}}" alt="slider img" width="1400" height="377" />
                    ...
                    <div class="caption sfr fadeout"
                        ...
                        data-start="2500" 
                        data-easing="easeInOutCubic">
                        <img src="{{asset('webmarket/images/dummy/slides/3/phone.png')}}" alt="phone in a hand" width="495" height="377" />
                    </div>
                ...
                <li data-transition="premium-random" data-slotamount="3">
                    <img src="{{asset('webmarket/images/dummy/slides/4/slide.jpg')}}" alt="slider img" width="1400" height="377" />
                    ...
                    <div class="caption lft ltt"
                        ...
                        data-start="2000" 
                        data-easing="easeInOutCubic">
                        <img src="{{asset('webmarket/images/dummy/slides/4/person1.png')}}" alt="satisfied customer" width="108" height="204" />
                    </div>
                    <div class="caption lft ltt"
                        data-x="0" 
                        data-y="0"
                        ...
                        data-start="2200" 
                        data-easing="easeInOutCubic">
                        <img src="{{asset('webmarket/images/dummy/slides/4/person2.png')}}" alt="satisfied customer" width="108" height="321" />
                    </div>
                    <div class="caption lft ltt"
                        data-x="500" 
                        data-y="0"
                        ...
                        data-start="2400" 
                        data-easing="easeInOutCubic">
                        <img src="{{asset('webmarket/images/dummy/slides/4/person3.png')}}" alt="satisfied customer" width="108" height="139" />
                    </div>
                    <div class="caption lft ltt"
                        data-x="720" 
                        data-y="0"
                        ...
                        data-start="2600" 
                        data-easing="easeInOutCubic">
                        <img src="{{asset('webmarket/images/dummy/slides/4/person4.png')}}" alt="satisfied customer" width="108" height="191" />
                    </div>
                    <div class="caption lft ltt"
                        data-x="940" 
                        data-y="0"
                        ...
                        data-start="2800" 
                        data-easing="easeInOutCubic">
                        <img src="{{asset('webmarket/images/dummy/slides/4/person5.png')}}" alt="satisfied customer" width="108" height="139" />
                    </div>
                    <div class="caption lft ltt"
                        data-x="1200" 
                        data-y="0"
                        ...
                        data-start="3000" 
                        data-easing="easeInOutCubic">
                        <img src="{{asset('webmarket/images/dummy/slides/4/person6.png')}}" alt="satisfied customer" width="108" height="179" />
                    </div>
                    <div class="caption lft ltt"
                        data-x="1350" 
                        data-y="0"
                        ...
                        data-start="3200" 
                        data-easing="easeInOutCubic">
                        <img src="{{asset('webmarket/images/dummy/slides/4/person7.png')}}" alt="satisfied customer" width="108" height="133" />
                    </div>
                    ...
                    <div class="slide">
    	            	...
    	            	<div class="span4">
    	            	    <div class="product">
    	            	        <div class="product-img featured">
    	            	            <div class="picture">
    	            	        	    <img src="{{asset('webmarket/images/dummy/featured-products/featured-1.png')}}" alt="" width="518" height="358" />
    	            	...
    	            	<div class="span4">
    	            	    <div class="product">
    	            	        <div class="product-img featured">
    	            	            <div class="picture">
    	            	        	    <img src="{{asset('webmarket/images/dummy/featured-products/featured-2.png')}}" alt="" width="518" height="358" />
    	            	        		<div class="img-overlay">
    	            	        		    <a href="#" class="btn more btn-primary">توضیحات بیشتر</a>
    	            	        		    <a href="#" class="btn buy btn-danger">خرید</a>
    	            	        		</div>
    	            	...
    	            	<div class="span4">
    	            	    <div class="product">
    	            	        <div class="product-img featured">
    	            	            <div class="picture">
    	            	        	    <img src="{{asset('webmarket/images/dummy/featured-products/featured-3.png')}}" alt="" width="518" height="358" />
    	            	        		<div class="img-overlay">
    	            	        		    <a href="#" class="btn more btn-primary">توضیحات بیشتر</a>
    	            	        		    <a href="#" class="btn buy btn-danger">خرید</a>
    	            	        		</div>
            ...
            <div class="row popup-products blocks-spacer">
            	...
            	<div class="span3">
            	    <div class="product">
            	        <div class="product-img">
                            <div class="picture">
                                <img src="{{asset('webmarket/images/dummy/products/product-6.jpg')}}" alt="" width="540" height="374" />
                                <div class="img-overlay">
                                    <a href="#" class="btn more btn-primary">توضیحات بیشتر</a>
            	...
            	<div class="span3">
            	    <div class="product">
            	        <div class="product-img">
                            <div class="picture">
                                <img src="{{asset('webmarket/images/dummy/products/product-7.jpg')}}" alt="" width="540" height="374" />
                                <div class="img-overlay">
                                    <a href="#" class="btn more btn-primary">توضیحات بیشتر</a>
                                    <a href="#" class="btn buy btn-danger">اضافه به سبد خرید</a>
                                </div>
            	...
            	<div class="span3">
            	    <div class="product">
            	        <div class="product-img">
                            <div class="picture">
                                <img src="{{asset('webmarket/images/dummy/products/product-8.jpg')}}" alt="" width="540" height="374" />
                                <div class="img-overlay">
                                    <a href="#" class="btn more btn-primary">توضیحات بیشتر</a>
                                    <a href="#" class="btn buy btn-danger">اضافه به سبد خرید</a>
                                </div>
            	...
            	<div class="span3">
            	    <div class="product">
            	        <div class="product-img">
                            <div class="picture">
                                <img src="{{asset('webmarket/images/dummy/products/product-9.jpg')}}" alt="" width="540" height="374" />
                                <div class="img-overlay">
                                    <a href="#" class="btn more btn-primary">توضیحات بیشتر</a>
                                    <a href="#" class="btn buy btn-danger">اضافه به سبد خرید</a>
                                </div>
            	...
            	<div class="span3">
            	    <div class="product">
            	        <div class="product-img">
                            <div class="picture">
                                <img src="{{asset('webmarket/images/dummy/products/product-10.jpg')}}" alt="" width="540" height="374" />
                                <div class="img-overlay">
                                    <a href="#" class="btn more btn-primary">توضیحات بیشتر</a>
                                    <a href="#" class="btn buy btn-danger">اضافه به سبد خرید</a>
                                </div>
            	...
            	<div class="span3">
            	    <div class="product">
            	        <div class="product-img">
                            <div class="picture">
                                <img src="{{asset('webmarket/images/dummy/products/product-11.jpg')}}" alt="" width="540" height="374" />
                                <div class="img-overlay">
                                    <a href="#" class="btn more btn-primary">توضیحات بیشتر</a>
                                    <a href="#" class="btn buy btn-danger">اضافه به سبد خرید</a>
                                </div>
            	...
            	<div class="span3">
            	    <div class="product">
            	        <div class="product-img">
                            <div class="picture">
                                <img src="{{asset('webmarket/images/dummy/products/product-12.jpg')}}" alt="" width="540" height="374" />
                                <div class="img-overlay">
                                    <a href="#" class="btn more btn-primary">توضیحات بیشتر</a>
                                    <a href="#" class="btn buy btn-danger">اضافه به سبد خرید</a>
                                </div>
            	...
            	<div class="span3">
            	    <div class="product">
            	        <div class="product-img">
                            <div class="picture">
                                <img src="{{asset('webmarket/images/dummy/products/product-13.jpg')}}" alt="" width="540" height="374" />
                                <div class="img-overlay">
                                    <a href="#" class="btn more btn-primary">توضیحات بیشتر</a>
                                    <a href="#" class="btn buy btn-danger">اضافه به سبد خرید</a>
                                </div>
	    	...
	    	<div class="row popup-products">
                ...
                <div class="span3">
                    <div class="product">
                        <div class="product-img">
                            <div class="picture">
                                <img src="{{asset('webmarket/images/dummy/most-popular-products/popular-1.jpg')}}" alt="" width="540" height="412" />
                                <div class="img-overlay">
                                    <a href="#" class="btn more btn-primary">توضیحات بیشتر</a>
                                    <a href="#" class="btn buy btn-danger">اضافه به سبد خرید</a>
                                </div>
                ...
                <div class="span3">
                    <div class="product">
                        <div class="product-img">
                            <div class="picture">
                                <img src="{{asset('webmarket/images/dummy/most-popular-products/popular-2.jpg')}}" alt="" width="540" height="412" />
                                <div class="img-overlay">
                                    <a href="#" class="btn more btn-primary">توضیحات بیشتر</a>
                                    <a href="#" class="btn buy btn-danger">اضافه به سبد خرید</a>
                                </div>
                ...
                <div class="span3">
                    <div class="product">
                        <div class="product-img">
                            <div class="picture">
                                <img src="{{asset('webmarket/images/dummy/most-popular-products/popular-3.jpg')}}" alt="" width="540" height="412" />
                                <div class="img-overlay">
                                    <a href="#" class="btn more btn-primary">توضیحات بیشتر</a>
                                    <a href="#" class="btn buy btn-danger">اضافه به سبد خرید</a>
                                </div>
                ...
                <div class="span3">
                    <div class="product">
                        <div class="product-img">
                            <div class="picture">
                                <img src="{{asset('webmarket/images/dummy/most-popular-products/popular-4.jpg')}}" alt="" width="540" height="412" />
                                <div class="img-overlay">
                                    <a href="#" class="btn more btn-primary">توضیحات بیشتر</a>
                                    <a href="#" class="btn buy btn-danger">اضافه به سبد خرید</a>
                                </div>
		...
		<div class="row">
		    <div class="span12">
		    	<div class="brands carouFredSel" data-nav="brands" data-autoplay="true">
                    <img src="{{asset('webmarket/images/dummy/brands/brands_01.jpg')}}" alt="" width="203" height="104" />
                    <img src="{{asset('webmarket/images/dummy/brands/brands_02.jpg')}}" alt="" width="203" height="104" />
                    <img src="{{asset('webmarket/images/dummy/brands/brands_03.jpg')}}" alt="" width="203" height="104" />
                    <img src="{{asset('webmarket/images/dummy/brands/brands_04.jpg')}}" alt="" width="203" height="104" />
                    <img src="{{asset('webmarket/images/dummy/brands/brands_05.jpg')}}" alt="" width="203" height="104" />
                    <img src="{{asset('webmarket/images/dummy/brands/brands_06.jpg')}}" alt="" width="203" height="104" />
                </div>
		    </div>
		</div> <!-- /logos -->
	</div> <!-- /brands carousel -->
